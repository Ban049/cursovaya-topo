...
namespace CursahLauncher
{
    public class Program
    {
        ...
        /// </summary>
        public static bool IsUpdateRequired(string currentVersionFilePath, string latestVersionName)
        {
            ...
            return currentVersion != latestVersionName;
        }
        /// <summary>
        ...
        static void CheckForUpdatesAndLaunch(string latestVersionName, string targetExePath)
        {
            ...
            if (IsUpdateRequired(CurrentVersionFile, latestVersionName))
            {
